...
[assembly: ExportEffect(typeof(Is_This_Vegan.UWP.TouchEffect), "TouchEffect")]

namespace Is_This_Vegan.UWP
{
    public class TouchEffect : PlatformEffect
    {
        FrameworkElement frameworkElement;
        Is_This_Vegan.Backend.TouchEffect effect;
        ...
        protected override void OnAttached()
        {
            ...
            effect = (Is_This_Vegan.Backend.TouchEffect)Element.Effects.
        ...
        {
            CommonHandler(sender, Is_This_Vegan.Backend.TouchActionType.Entered, args);
        }

        void OnPointerPressed(object sender, PointerRoutedEventArgs args)
        {
            CommonHandler(sender, Is_This_Vegan.Backend.TouchActionType.Pressed, args);
