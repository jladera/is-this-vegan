...
namespace Is_This_Vegan_Test.Testing_Helpers
{
    public class SecondaryCleanPipelineCollection
    {
        public class ExtractDualNamedIngredients : TestCollection
        {
            public ExtractDualNamedIngredients()
            {
                ...
                IngredientLists.Add(new TestingModel()
                {
                    ...
                    Expected = "water\\aqua\\eau, butylene glycol, methypropanediol, 1,2-hexanediol, sodium hyaluronate, camellia sinensis (green tea) leaf extract, caffeine, coffea arabica (coffee) seed extract, glycerin, trehalose, panthenol, arginine, dipotassium glycyrrhizate, ethylhexylglycerin, dimethicone, dimethicone/peg-10/15 crosspolymer, glycereth-26, epigallocatechin gallate, tocophersolan, xanthan gum, decyl glucoside, trideceth-6, carbomer poloxamer 235, ploxamer 338, dipropylene glycol, propanediol, ethylhexyl stearate, sodium polyacrylate, ammonium acryloydimethyltaurate/vp copolymer, peg-40 hydrogenated castor oil, hexylcinnamal, disodium edta, phenoxyethanol <iln46462>"
                });
                ...
                IngredientLists.Add(new TestingModel()
                {
                    ...
                    Expected = "cetearyl ethylhexanoate, prunus amygdalus dulcis (sweet almond) oil, glyceryl stearate, stearyl heptanoate, squalane, polysorbate 20, cetearyl alcohol, phenoxyethanol, benzyl alcohol, limonene, fragrance, saccharomyces (hungarian thermal water) ferment extract, tocopherol, ethylhexylglycerin, hungarian thermal water, linalool, malpighia punicifolia (acerola) fruit extract, phospholipids"
                });
        ...
        public class FindIngredients : TestCollection
        {
        ...
        public class ReplaceSubingredients : TestCollection
        {
            public ReplaceSubingredients()
            {
                ...
                IngredientLists.Add(new TestingModel()
                {
                    Filename = "belvita_vanilla-cookie.jpg",
                    Input = "whole grain wheat flour, enriched flour [wheat flour, niacin, reduced iron, thiamin mononitrate (vitamin b1), riboflavin (vitamin b2), folic acid}, sugar, canola oil, whole grain rolled oats, whole grain rye flour, baking soda, disodium pyrophosphate, salt, soy lecithin, datem, natural flavor, ferric orthophosphate (iron), niacinamide,  pyridoxine hydrochloride (vitamin b6), riboflavin (vitamin b2),  thiamin mononitrate (vitamin b1).",
                    Expected = "whole grain wheat flour, wheat flour, niacin, reduced iron, thiamin mononitrate (vitamin b1), riboflavin (vitamin b2), folic acid, sugar, canola oil, whole grain rolled oats, whole grain rye flour, baking soda, disodium pyrophosphate, salt, soy lecithin, datem, natural flavor, ferric orthophosphate (iron), niacinamide,  pyridoxine hydrochloride (vitamin b6), riboflavin (vitamin b2),  thiamin mononitrate (vitamin b1)."
                });
                ...
                {
                    Filename = "jin_ramen.jpg",
                    Input = "wheat flour, modified starch (potato, tapioca), palm oil, potato starch, wheat gluten, salt, yeast extract, acidity regulator (potassium carbonate, sodium polyphosphate), riboflavin, salt, sugar, soy sauce powder (soy bean, wheat, salt), garlic powder, spices (red pepper, garlic, onion, green onion, ginger), monosodium glutamate, glucose, hydrolyzed vegetable protein (soy, wheat, corn), chili extract, yeast extract powder, black pepper, red pepper, kelp extract powder, disodium inosinate, disodium guanylate, dextrin, malic acid, chinese cabbage, textured vegetable protein (soy, wheat), carrot, green onion, mushroom, red pepper",
                    Expected = "wheat flour, potato, tapioca, palm oil, potato starch, wheat gluten, salt, yeast extract, potassium carbonate, sodium polyphosphate, riboflavin, salt, sugar, soy bean, wheat, salt, garlic powder, red pepper, garlic, onion, green onion, ginger, monosodium glutamate, glucose, soy, wheat, corn, chili extract, yeast extract powder, black pepper, red pepper, kelp extract powder, disodium inosinate, disodium guanylate, dextrin, malic acid, chinese cabbage, soy, wheat, carrot, green onion, mushroom, red pepper"
                });
